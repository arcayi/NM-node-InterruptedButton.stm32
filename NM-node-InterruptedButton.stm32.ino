...
// General settings
#define SKETCH_NAME "NM-node-Button.stm32"
...
// SensorDigitalInput di1(PB12, 1);
// SensorDigitalInput di2(PB13, 2);
// SensorDigitalInput di3(PB14, 3);

#include <sensors/SensorInterruptedButton.h>
// SensorInterruptedButton ib0(PA0);
SensorInterruptedButton ib1(PA1);
SensorInterruptedButton ib2(PA2);
...
void before() {
    ...
    nodeManager.setInterruptDebounce(200);
